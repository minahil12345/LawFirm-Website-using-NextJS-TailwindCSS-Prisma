    ...
    <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-2.5">
      ...
      <div className="flex-1 lg:flex-[3] bg-white p-6 rounded-[10px] shadow-md">
        ...
        <div className="space-y-4 text-base leading-7">
          ...
          <p>“Legal representation shouldn't depend on how much money you make,” said <strong>Managing Partner Jane Walters</strong>. “With rising costs and limited access to public defenders for civil matters, many people are left vulnerable. Our team felt compelled to act.”</p>
